...
--
-- Host: mysql:3306
-- Generation Time: May 05, 2024 at 12:24 AM
...
CREATE TABLE `map_po_plos` (
  `id_po_plo` int UNSIGNED NOT NULL,
...
CREATE TABLE `plos` (
  ...
  `ploName` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `pos` (
  `po_id` int UNSIGNED NOT NULL,
  `description` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `poName` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `program_id` int UNSIGNED NOT NULL,
  `isDelete` tinyint(1) NOT NULL DEFAULT '0',
  `createdAt` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updatedAt` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
...
CREATE TABLE `programs` (
  `program_id` int UNSIGNED NOT NULL,
  `programName` text COLLATE utf8mb4_general_ci NOT NULL,
...
--
ALTER TABLE `map_po_plos`
  MODIFY `id_po_plo` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT for table `plos`
--
ALTER TABLE `plos`
  MODIFY `plo_id` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;

--
-- AUTO_INCREMENT for table `pos`
--
ALTER TABLE `pos`
  MODIFY `po_id` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT for table `programs`
--
ALTER TABLE `programs`
  MODIFY `program_id` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
